    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                <img src="{{ asset('images/logo.png') }}" alt="CV. Surya Agung Logo" height="35" class="me-2">
                <div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex">
                    <a href="https://wa.me/+6285232328282" class="btn btn-contact d-flex align-items-center" target="_blank">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <div class="d-flex justify-content-md-end gap-2 mt-2 mt-md-0">
                        <a href="https://wa.me/+6285232328282" class="btn btn-warning btn-sm">
